...
function AlertPanamericana(mensaje,Tipo,titulo) {
    var sticky = true;
    var duration = Math.floor(Math.random() * 5001) + 1000;
    var type = 'warn';
...
window.alert = function (message, tipo, titulo) {
    tipo = tipo ? tipo : 'warn';
    titulo = titulo ? titulo : 'PANAMERICANA ';
    AlertPanamericana(message, tipo, titulo);
};