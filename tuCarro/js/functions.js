...
//set offset
  ...
  $("#navbar .nav-link").on('click', function(event) {
    ...
    $('.navbar-collapse').collapse('hide');
      ...
      if (_lnk.attr('compor') == 'externo') {
          window.open(_lnk.attr('href'), '_blank');
      } else {
          var hash = this.hash;
...
***********************************/
    ...
    // Fecha: 12-11-2020
    //Descripción: Se inhabilita script ya que se maneja dinámicamente el carrusel por AJAX para los cumpleaños de la Intranet
  ...
  $(".gallery").lightGallery({
    ...
    ************************************/
    if (typeof Isotope == 'function') {
        /* init Isotope*/
        // var $container = $('.portfCambio-list').isotope({
        //   itemSelector: '.item',
        //   layoutMode: 'fitRows',
        ...
        var container = $('.portfCambio-list')
        // initialize Isotope
        container.isotope({
            itemSelector: 'li',
            gutter: 0,
        ...
        $('.portfCambio-filter').on('click', 'button', function () {
